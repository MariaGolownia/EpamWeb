...
public class OrderPageCommand extends BaseCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (selectedLocation != null) {
            ...
            request.setAttribute("selectCountry", selectedLocation.getCountry().getName());
            request.setAttribute("selectCity", selectedLocation.getCity().getName());
...
//            }
        ...
        if (selectedUserInfo != null) {
            ...
            request.setAttribute("selectSurname", selectedUserInfo.getSurname());
            request.setAttribute("selectName", selectedUserInfo.getName());
        }
